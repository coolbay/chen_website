...
summary: To alleviate the heavy computation problem in TAD, we first propose an efficient action detector with detector proposal sampling, based on the observation that performance saturates at a small number of proposals. 
draft: false
featured: true
tags:
  - Deep learning
